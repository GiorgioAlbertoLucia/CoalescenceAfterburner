#ifndef COALESCENCEENGINELI4_H
#define COALESCENCEENGINELI4_H
...
// ─────────────────────────────────────────────────────────────────────────────
// CoalescenceEngineLi4
//
// Event-by-event Li4 (3p+1n) coalescence via the A-body Wigner function.
//
// For each unique (p,p,p,n) quartet in an event:
...
// Wigner density — shared as a non-owning pointer from IntegratorA4.
// ─────────────────────────────────────────────────────────────────────────────

class CoalescenceEngineLi4 {
public:

    CoalescenceEngineLi4(const SourceSize&               srcNucleon,
