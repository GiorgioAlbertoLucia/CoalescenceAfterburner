...
//
// Event-by-event He4 (2p+2n) coalescence via the A-body Wigner function.
//
...
class CoalescenceEngineHe4 {
public:

    CoalescenceEngineHe4(const SourceSize&               srcNucleon,
...
private:
    ...
    // QA histograms
    TH1D* fHNucleusYield{nullptr};
    TH1D* fHNucleusYieldUncertainty{nullptr};
